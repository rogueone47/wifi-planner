...
document.getElementById("close-btn").addEventListener("click", ()=>{
  document.getElementById("modal-base").classList.replace("display", "close");
  document.getElementById("overlay").classList.replace("display", "close");
});
document.getElementById("export").addEventListener("click", ()=>{
  document.getElementById("modal-base").classList.replace("close", "display");
  document.getElementById("overlay").classList.replace("close", "display");
});
